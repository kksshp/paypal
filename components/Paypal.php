...
class Paypal extends CComponent {
    ...
    public function init() {
        $this->paypalSandbox = Yii::app()->getModule('paypal')->paypalSandbox;

        $this->paypalUrl = Yii::app()->getModule('paypal')->paypalUrl;
        $this->endPoint = Yii::app()->getModule('paypal')->endPoint;

        $this->returnUrl = Yii::app()->createAbsoluteUrl(Yii::app()->getModule('paypal')->returnUrl);
        $this->cancelUrl = Yii::app()->createAbsoluteUrl(Yii::app()->getModule('paypal')->cancelUrl);
        $this->notifyUrl = Yii::app()->createAbsoluteUrl(Yii::app()->getModule('paypal')->notifyUrl);

        $this->currency = Yii::app()->getModule('paypal')->currency;
        $this->businessEmail = Yii::app()->getModule('paypal')->businessEmail;
